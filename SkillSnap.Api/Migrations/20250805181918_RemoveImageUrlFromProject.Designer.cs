...
namespace SkillSnap.Api.Migrations
{
    ...
    [Migration("20250805181918_RemoveImageUrlFromProject")]
    partial class RemoveImageUrlFromProject
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PortfolioUser", b =>
                {
                    b.HasOne("SkillSnap.Api.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("SkillSnap.Api.Models.Project", b =>
                {
                    b.HasOne("PortfolioUser", "PortfolioUser")
                        .WithMany("Projects")
